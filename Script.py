...
‣ ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href='https://t.me/basildmx'>ʙᴀꜱɪʟᴅᴍx/a> 
‣ ʟɪʙʀᴀʀʏ : <a href='https://docs.pyrogram.org/'>ᴘʏʀᴏɢʀᴀᴍ</a> 
‣ ʟᴀɴɢᴜᴀɢᴇ : <a href='https://www.python.org/download/releases/3.0/'>ᴘʏᴛʜᴏɴ 3</a> 
‣ ᴅᴀᴛᴀ ʙᴀsᴇ : <a href='https://www.mongodb.com/'>ᴍᴏɴɢᴏ ᴅʙ</a> 
‣ ʙᴏᴛ sᴇʀᴠᴇʀ : <a href='https://heroku.com'>ʜᴇʀᴏᴋᴜ</a> 
‣ ʙᴜɪʟᴅ sᴛᴀᴛᴜs : ᴠ7.7.1 [sᴛᴀʙʟᴇ]></b>"""
...
my features Stay here new features coming soon...  
 ...
 <b>✯ Join here : <a href=https://t.me/dmx_chating>ꜰᴏʀ ᴜᴩᴅᴀᴛᴇꜱ</a></b> 
 ...
 ./video - This command usage any YouTube video download hd [<code>example /video https://youtube.com</code>]
...
🫵 ᴛʜɪꜱ ꜰᴇᴀᴛᴜʀᴇ ɪꜱ ɴᴏᴏ ᴍᴏʀᴇ ᴀᴠᴀɪʟᴀʙᴇ """
...
• /plink - <code>Jᴜsᴛ ʟɪᴋᴇ /link, ʙᴜᴛ ᴛʜᴇ ғɪʟᴇ ᴡɪʟʟ ʙᴇ sᴇɴᴅ ᴡɪᴛʜ ғᴏʀᴡᴀʀᴅ ʀᴇsᴛʀɪᴄᴛɪᴏɴ.</code>"""
 ...
 ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ʜᴇʟᴩꜱ yᴏᴜ ᴛᴏ ᴛʀᴀɴꜱʟᴀᴛᴇ ᴀ ᴛᴇxᴛ ᴛᴏ ᴀɴy ʟᴀɴɢᴜᴀɢᴇꜱ yᴏᴜ ᴡᴀɴᴛ. ᴛʜɪꜱ ᴄᴏᴍᴍᴀɴᴅ ᴡᴏʀᴋꜱ ᴩᴍ ᴀɴᴅ ɢʀᴏᴜᴩ
...
-[ᴏᴡɴᴇʀ ᴏꜰ ᴛʜɪꜱ ʙᴏᴛ]<a href='https://t.me/basildmx'>ᴠɪʙᴇʀʟᴀᴡ</a>
"""
